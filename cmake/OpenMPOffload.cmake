...
function(omp_configure_offload target_name)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "Clang|LLVM|AppleClang|IntelLLVM")
    ...
    # Helpful macros for runtime logging
    target_compile_definitions(${target_name} PRIVATE OMP_OFFLOAD_ENABLED=1)
    if(OMP_OFFLOAD_VENDOR STREQUAL "NVIDIA")
      target_compile_definitions(${target_name} PRIVATE OMP_OFFLOAD_VENDOR_NVIDIA=1 OMP_OFFLOAD_VENDOR_NAME="\"NVIDIA\"")
    elseif(OMP_OFFLOAD_VENDOR STREQUAL "AMD")
      target_compile_definitions(${target_name} PRIVATE OMP_OFFLOAD_VENDOR_AMD=1 OMP_OFFLOAD_VENDOR_NAME="\"AMD\"")
    elseif(OMP_OFFLOAD_VENDOR STREQUAL "INTEL")
      target_compile_definitions(${target_name} PRIVATE OMP_OFFLOAD_VENDOR_INTEL=1 OMP_OFFLOAD_VENDOR_NAME="\"INTEL\"")
    endif()
    if(OMP_TARGET_ARCH)
      target_compile_definitions(${target_name} PRIVATE OMP_TARGET_ARCH_STR="\"${OMP_TARGET_ARCH}\"")
    endif()
